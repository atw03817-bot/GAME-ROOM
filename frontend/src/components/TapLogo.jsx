...
// Tap Official Logo Component
// Using official Tap logo from: https://www.tap.company
const TapLogo = ({ 
  size = 'medium', 
  variant = 'default', 
  className = '',
  ...
  return (
    <div className={`inline-flex items-center ${className}`}>
      {/* Tap Official Logo - Using local SVG */}
      <svg
...
// Tap Badge Component for Payment Methods
export const TapBadge = ({ className = '', size = 'medium' }) => {
  return (
    <div className={`inline-flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg ${className}`}>
      <TapLogo size={size} />
      <div className="text-right">
        <div className="text-xs text-gray-600">بطاقة ائتمانية آمنة</div>
      </div>
    </div>
  );
};

// Tap Payment Option Component
export const TapPaymentOption = ({ 
  selected = false, 
  onClick, 
  className = '',
  amount = null 
